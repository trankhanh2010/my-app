            ...
            <table className="table-auto w-full text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <Thead
                    fields={[
                        ...
                        { fieldName: fieldLabels.testServiceTypeList.tdlServiceCode, css: `w-[5%] pl-8 truncate` },
                                ...
                                <React.Fragment key={serviceType}>
                                    ...
                                    {expandedGroups.serviceType[patientGroup.patientType]?.[serviceType] && patientGroup.services[serviceType].map((record) => (
                                        <tr key={record.id} className="hover:bg-gray-50 cursor-pointer">
                                            <GroupTd
                                                fields={[
                                                    {fieldValue:record.tdlServiceName, css:`pl-8 truncate ${Number(record.virTotalPatientPrice) == 0 ? "italic bg-green-50 text-green-400" : ""}`},
                                                    ...
                                                    {fieldValue:record.tdlServiceCode, css:`pl-8 ${Number(record.virTotalPatientPrice) == 0 ? "italic bg-green-50 text-green-400" : ""}`},
