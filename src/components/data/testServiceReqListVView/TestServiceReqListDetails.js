    ...
    return (
        <div className="text-xs">
            ...
            <div className="flex flex-col md:flex-row md:space-x-2 border border-gray-300 p-4">
                ...
                <div className="w-full flex flex-col md:w-[25%] whitespace-pre-line break-words">
                    <div className="w-full border-b-2 pt-2 pb-2  bg-gray-100">
                        <p className="p-1 flex-grow font-semibold"><span className="font-semibold uppercase">Tổng chi phí: </span>
                            {totalVirPrice.toLocaleString()}
                        </p>
                        <p className="p-1 flex-grow font-semibold"><span className="font-semibold uppercase">BHYT thanh toán: </span>
                            {totalHeinPrice.toLocaleString()}
                        </p>
                        <p className="p-1 flex-grow font-semibold"><span className="font-semibold uppercase">Nguồn khác thanh toán: </span>
                            {totalOtherSourcePrice.toLocaleString()}
                        </p>
                        <p className="p-1 flex-grow font-semibold"><span className="font-semibold uppercase">Công ty thanh toán: </span>
                        </p>
                        <p className="p-1 flex-grow font-semibold"><span className="font-semibold uppercase">BN phải thanh toán: </span>
                            {totalPatientPrice.toLocaleString()}
                        </p>
                        <p className="p-1 flex-grow font-semibold"><span className="font-semibold uppercase">Miễn giảm: </span>
                        </p>
                    </div>
                    <div className="w-full border-b-2 pt-2 pb-2  bg-gray-100">
                        <p className="p-1 flex-grow text-red-600 font-semibold"><span className="font-semibold uppercase">BN cần nộp thêm: </span>
                            {(totalPatientPrice - selectedRecord.totalTreatmentBillAmount).toLocaleString()}
                        </p>
                    </div>
                    <div className="w-full border-b-2 pt-2 pb-2  bg-gray-100">
                        <p className="p-1 flex-grow text-blue-600 font-semibold"><span className="font-semibold uppercase">Đã thu: </span>
                            {Number(selectedRecord.totalTreatmentBillAmount).toLocaleString()}
                        </p>
                        <p className="p-1 flex-grow font-semibold"><span className="font-semibold uppercase">Tạm ứng: </span>
