    ...
    return (
        <>
            ...
            <GroupFieldSpanWithText 
                fields={[
                    {fieldName:fieldLabels.patientCode, fieldValue:recordDetails.patientCode, divCss:`md:w-[30%] md:border-r`},
                    {fieldName:fieldLabels.patientName, fieldValue:recordDetails.patientName, divCss:`md:w-[40%] md:border-r`},
                    {fieldName:fieldLabels.dateOfBirth, fieldValue:recordDetails.dateOfBirth ? format(convertToDate(recordDetails.dateOfBirth), "dd/MM/yyyy") : "", divCss:`md:w-[30%] md:border-r`},
                ]}
            />
            <GroupFieldSpanWithText 
                css='mt-1'
