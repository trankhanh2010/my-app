    ...
    return (
        <>
            ...
            <GroupFieldSpanWithText
                fields={[
                    { fieldName: fieldLabels.patientName, fieldValue: recordDetails.patientName, divCss: `md:w-[30%] md:border-r` },
                    ...
                    { fieldName: fieldLabels.gender, fieldValue: recordDetails.gender, divCss: `md:w-[10%] md:border-r` },
                    { fieldName: fieldLabels.address, fieldValue: recordDetails.address, divCss: `md:w-[40%]` },
                ]}
            />
            <GroupFieldSpanWithText
                css='mt-1'
                fields={[
                    { fieldName: fieldLabels.heinCardNumber, fieldValue: recordDetails.heinCardNumber, divCss: `md:w-[30%] md:border-r whitespace-pre-line break-words` },
                    { fieldName: fieldLabels.rightRouteCode, fieldValue: recordDetails.rightRouteCode === 'DT' ? "Đúng tuyến" : recordDetails.rightRouteCode === 'TT' ? "Trái tuyến" : "", divCss: `md:w-[20%] md:border-r` },
                    ...
                    { fieldName: fieldLabels.heinMediOrgName, fieldValue: recordDetails.heinMediOrgName, divCss: `md:w-[25%]` },
                ]}
            />
            <GroupFieldSpanWithText
                css='mt-1'
