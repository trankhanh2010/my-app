...
import DepositReqListNoLogin from "../../../../pages/data/depositReqListVView/DepositReqListNoLogin";
        ...
        <div className={`fixed inset-0 z-50 flex items-center justify-center bg-gray-500/75`}>
            <div className={`relative bg-white w-full md:w-[100%] h-full overflow-auto max-h-screen ${zoom ? '' : 'md:w-[75%] md:h-auto'}`}>
                <ButtonModal
                    ...
                    zoom={zoom}
                    setZoom={setZoom}
                    title='Danh sách các yêu cầu tạm ứng đã được thanh toán'
                />
                {children}
                <DepositReqListNoLogin
